                  ...
                  {isLoadingSuggestions ? (
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      {suggestions.map((suggestion, index) => (
                        <BlurFade key={suggestion.id} delay={0.15 + index * 0.05}>
                          <UseCaseCard
                ...
                <div>
                  ...
                  <div className="space-y-4">
                    {customIdeas.map((idea, index) => (
                      <BlurFade key={idea.id} delay={0.35 + index * 0.05}>
                        <DemoIdeaForm
                          idea={idea}
                          index={index}
                          onChange={handleIdeaChange}
                          onRemove={handleRemoveIdea}
                          canRemove={customIdeas.length > 1}
                        />
                      </BlurFade>
                    ))}

                    {customIdeas.length < 3 && (
                      <Button
                        variant="outline"
