        ...
        <div className="space-y-2">
          {PRICING.creditTiers.map((tier) => {
            ...
            return (
              <button
                key={tier.commitment}
                onClick={() => onCommitmentChange(tierCommitment)}
                className={cn(
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="text-left">
                    <div className="flex items-center gap-2">
                      ...
                      {isOptimal && (
                        <span className="inline-flex items-center gap-1 px-2 py-0.5 bg-[#D4F9E4] border border-[#4AE88A]/30 rounded-full text-xs font-medium text-[#2B8A4B]">
                          <Sparkles className="w-3 h-3" />
                          Recommended
                        </span>
                      )}
                      {tier.commitment === 1000000 && (
                        <span className="px-2 py-0.5 bg-amber-100 dark:bg-amber-900/30 border border-amber-200 dark:border-amber-700 rounded-full text-xs font-medium text-amber-700 dark:text-amber-400">
                          Best Rate
                        </span>
                      )}
                    </div>
